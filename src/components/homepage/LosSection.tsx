...
const ArtistSection = () => {
  ...
  return (
    <section className="artist-section relative w-full h-[90vh] m-0 p-0 overflow-hidden z-20">
      {/* Carousel Background */}
      {artistData && <Carousel items={artistData.photosCollection.items} reverse={true} />}

      {/* Slanted Section */}
      <div className="slanted-section flex flex-row absolute top-0 m-0 h-[105%] w-full bg-neutral-950 opacity-90 text-white z-10">
        <div className="divide-container flex flex-col mr-6 mb-6 h-[70%] w-[38%] justify-center self-center">
          ...
          <div className='content-container flex flex-col ml-6 mt-2 h-auto w-[90%] items-center text-center'>
              ...
              <Divider className="mb-6 max-w-[85%]" />
                  <p>Specializes in black and grey realism, portrait, and religious pieces.</p>   
                  <p>{artistData.bio}</p>   
